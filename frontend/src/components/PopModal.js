...
function PopModal({ addToCart, mealItem }) {
  ...
  const handleAddToCart = () => {
    console.log("handle cart function: ", mealItem, quantity);
    const updatedMealItem = { ...mealItem, quantity }; // Renamed variable
    console.log("meal item with quantity", updatedMealItem);
    addToCart(updatedMealItem, quantity);
    onClose();
  };
