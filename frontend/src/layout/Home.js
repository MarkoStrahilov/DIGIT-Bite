...
const Home = () => {
    ...
    return (
        ...
        >
            <Navbar />
            <Box ml={[2, 4, 300]} mt={[10, 15, 90]} display={"flex"} flexDirection={["column", "column", "row-reverse"]} alignItems={"center"}>
                <Box>
                ...
                <Box flexShrink={0} flexWrap={"wrap"}  mb={[0, 0, 0]} mr={[0,0, 0, "150px"]} ml={[0,0,"-60px"]}  maxHeight={["auto","auto","60vh"]} width={["100%", "100%", 500, 680]}>
                    <img
                        src={burger}
                        alt="Burger"
